...
public class AJobScheduler {
    ...
    public static void jobTips(@NotNull Bot bot) throws SchedulerException {
        ...
        if(Config.INSTANCE.getGroupNewsJob().get("Open").equals("true")){
            ...
            Trigger GroupNewsTrigger = TriggerBuilder.newTrigger()
                    ...
                    .startNow()//立即生效
                    .withSchedule(CronScheduleBuilder.cronSchedule(Config.INSTANCE.getGroupNewsJob().get("Cron"))
                            .inTimeZone(TimeZone.getTimeZone(Config.INSTANCE.getGroupNewsJob().get("Zone")))
                    ).build();
        ...
        if(Config.INSTANCE.getGroupCanlendarJob().get("Open").equals("true")){
            ...
            Trigger GFCtrigger = TriggerBuilder.newTrigger()
                    ...
                    .startNow()//立即生效
                    .withSchedule(CronScheduleBuilder.cronSchedule(Config.INSTANCE.getGroupCanlendarJob().get("Cron"))
                            .inTimeZone(TimeZone.getTimeZone(Config.INSTANCE.getGroupCanlendarJob().get("Zone")))
                    ).build();
